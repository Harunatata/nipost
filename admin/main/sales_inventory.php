...
<div class="container-fluid">
	...
	<div class="span2">
          <div class="well sidebar-nav">
			...
			<li class="active"><a href="sales_inventory.php"><i class="icon-table icon-2x"></i>Parcel Inventory</a>                </li>
			<br><br>		
			<li>
	...
	<div class="contentheader">
			<i class="icon-bar-chart"></i> Parcel Inventory
			</div>
<br>
...
<table class="table table-bordered" id="resultTable" data-responsive="table" style="text-align: left;">
	<thead>
		<tr>
			...
			<th width="9%"> Date </th>
			<th width="14%"> Parcel Name </th>
			<th width="16%"> Parcel Type</th>
			<th > Price </th>
			<th> QTY </th>
	...
	<tbody>
			...
			<tr>
				...
				<?php
				$resultas = $db->prepare("SELECT sum(total) from sales_order");
