...
function setUpdateAction() {
	...
	document.frmUser.action = "updatedist1.php";
	document.frmUser.submit();
	}
}

function setLocation() {
if(confirm("Are you sure Before yous Update Location?")) {
document.frmUser.action = "location.php";
document.frmUser.submit();
}
}
...
function setArriveAction() {
	...
	document.frmUser.action = "updateArrive1.php";
	document.frmUser.submit();
	}
}
// End -->
...
<div class="container-fluid">
	...
	<div class="span2">
          <div class="well sidebar-nav">
              ...
              <li class="active"><a href="index.php"><i class="icon-dashboard icon-2x"></i> DRIVER </a></li> 
...
<table class="table table-bordered" id="resultTable" data-responsive="table" style="text-align: left;">
	...
	<tbody>
			...
			?>
		<tr><td> <input class="btn btn-warning btn-mini" type="button" name="update" value="Departure" onClick="setUpdateAction();" /></td><td></td><td> <input class="btn btn-warning btn-mini" type="button" name="arrive" value="ARRIVE" onClick="setArriveAction();" /></td><td><input name="locate" type="text" placeholder="Current Location" title="Enter you current Location" onDblClick="setLocation();" height="50px" size="40px"></td></tr>
	</tbody>
</table>
</form>
