...
<?php include('navfixed.php');?>
	...
	<div class="span2">
			...
			<li class="active"><a href="sales.php?id=cash&invoice"><i class="icon-shopping-cart icon-2x"></i>Parcel</a>  </li> 
            <li><a href="allocate.php"><i class="icon-shopping-cart icon-2x"></i>Allocate Parcel</a></li>             
...
<div style="margin: 0 auto; padding: 20px; width: 900px; font-weight: normal;">
	...
	<center>
    		  <div style="font:bold 25px 'Aleo';">Parcel Receipt</div>
	...
	<table border="1" cellpadding="4" cellspacing="0" style="font-family: arial; font-size: 12px;	text-align:left;" width="100%">
		...
		<tbody>
				...
				?>
				<tr>
					<td colspan="5"style=" text-align:right;"><strong style="font-size: 12px; color: #222222;">&nbsp;</strong></td>
